...
import { Avatar, Button, Collapse, DatePicker, Flex, Form, InputNumber, List, Modal, Popover } from "antd";
import { CiEdit } from "react-icons/ci";
import { IoIosArrowBack } from "react-icons/io";



function UpdateDeleteOrderCustomTour() {
  ...
  const fetchFarmFish = async () => {
    try {
      const response = await api.get(
        `koi/list-koi/custom-booking-id?customBookingId=${order.customBooking.customBookingId}`
      );
      ...
      <Flex justify="space-around">
        <div className="consul-viewOrder-listFish">
          <div className="update-order-button">
            {order?.status !== "CANCEL" && order?.status !== "CONFIRM" && (
...
export default UpdateDeleteOrderCustomTour
